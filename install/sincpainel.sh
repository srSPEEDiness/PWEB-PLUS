...
wget https://github.com/srSPEEDiness/PWEB-PLUS/main/install/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/srSPEEDiness/PWEB-PLUS/main/install/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/srSPEEDiness/PWEB-PLUS/main/install/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/srSPEEDiness/PWEB-PLUS/main/install/sincpainel.zip > /dev/null 2>&1
