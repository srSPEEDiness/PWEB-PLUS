#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR PWEB SPEED PLUS\033[0m"
...
wget https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/Jhowmt1989/Jhowpainelweb/raw/main/painelwv5/sincpainel.zip > /dev/null 2>&1
